...
const ViewEmail = () => {
    ...
    return (
        <Box style={openDrawer ? { marginLeft: 250 , width: '100%'} : { width: '100%' }}>
            <IconWrapper>
                <ArrowBackIcon onClick={() => window.history.back()} color="action" fontSize="small"></ArrowBackIcon>
                <DeleteOutlinedIcon fontSize="small" color="action" style={{ marginLeft: 40 }} onClick={()=> deleteEmail()} />
            </IconWrapper>
            <Subject>
                {email.subject}
